    ...
    .once('value', function(snap) {
        if(snap.val()) {
            ...
            var dataValues = 
            {
              ...
              "serialNumber":currentOrder.id+'O'+currentOrder.ordertTimeStamp,
              "children":[],
              "udfs": {
                "zone": {
                    "value": "unknown"
            ...
            requestify.request(configDB.vizixserved+"/"+currentOrder.orderthingid , {
            method: 'PATCH',
...
app.get("/refreshDashboard", function(request, response) {
    requestify.request(configDB.vizixdasboard , {
        method: 'POST',
        headers : {'Content-Type': 'application/json'},
        dataType: 'json' ,
